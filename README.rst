...
* Information on how to **cite the SpecHomo Python package** can be found in the
  `CITATION <https://git.gfz.de/geomultisens/spechomo/-/blob/main/CITATION>`__ file.
* Submit feedback by filing an issue `here <https://git.gfz.de/geomultisens/spechomo/issues>`__
...
.. image:: https://git.gfz.de/geomultisens/spechomo/badges/main/pipeline.svg
        :target: https://git.gfz.de/geomultisens/spechomo/commits/main
.. image:: https://git.gfz.de/geomultisens/spechomo/badges/main/coverage.svg
...
.. image:: https://img.shields.io/pypi/l/spechomo.svg
        :target: https://git.gfz.de/geomultisens/spechomo/blob/main/LICENSE
